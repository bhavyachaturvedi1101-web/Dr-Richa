...
import { Search, Link, Crosshair, Image as ImageIcon } from 'lucide-react';
                ...
                >
                  ...
                  <div className="flex flex-col justify-center">
                    <div className="flex items-center gap-3 mb-4">
                      {feature.icon && <feature.icon className={`w-8 h-8 ${feature.textColor}`} />}
                      <h3 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white">{feature.title}</h3>
                    </div>
