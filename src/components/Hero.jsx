...
const styles = {
  ...
  bgImage: {
    ...
    opacity: 0.9,
    WebkitMaskImage: 'radial-gradient(ellipse 80% 90% at 70% 50%, rgba(0, 0, 0, 1) 45%, rgba(0, 0, 0, 0) 88%)',
    maskImage: 'radial-gradient(ellipse 80% 90% at 70% 50%, rgba(0, 0, 0, 1) 45%, rgba(0, 0, 0, 0) 88%)',
