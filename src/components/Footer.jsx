      ...
      <div style={styles.widgetsWrapper}>
        ...
        >
          <svg viewBox="0 0 24 24" width="24" height="24" fill="#ffffff">
            <path d="M.057 24l1.687-6.163c-1.041-1.804-1.588-3.849-1.587-5.946C.06 5.348 5.397.01 12.008.01c3.202.001 6.212 1.246 8.477 3.514 2.266 2.268 3.507 5.28 3.505 8.484-.004 6.657-5.34 11.997-11.953 11.997-2.005-.001-3.973-.502-5.724-1.455L0 24zm6.59-4.846c1.6.95 3.188 1.449 4.825 1.451 5.436 0 9.86-4.37 9.864-9.799.002-2.63-1.023-5.101-2.885-6.963C16.57 1.981 14.1 1.953 11.97 1.953c-5.437 0-9.861 4.37-9.865 9.8.001 1.955.514 3.508 1.5 5.1l-.988 3.606 3.73-.974zm13.125-7.391c-.272-.137-1.614-.797-1.863-.885-.25-.089-.432-.133-.613.137-.182.271-.703.885-.863 1.062-.16.177-.318.199-.59.063-.272-.137-1.147-.423-2.185-1.348-.808-.72-1.353-1.61-1.512-1.882-.16-.272-.017-.419.119-.554.122-.122.272-.319.408-.478.136-.159.182-.272.272-.453.091-.182.046-.341-.023-.478-.068-.137-.613-1.483-.84-2.03-.22-.53-.443-.457-.613-.466-.16-.008-.341-.01-.523-.01s-.477.068-.727.341c-.25.272-.954.933-.954 2.273s.977 2.635 1.114 2.818c.137.182 1.923 2.937 4.657 4.116.65.281 1.157.449 1.552.574.654.208 1.25.178 1.721.108.524-.078 1.614-.66 1.84-.13.227-.57.227-1.064.159-1.154-.069-.091-.25-.137-.52-.272z" />
          </svg>
        </motion.a>
        ...
        <motion.button 
          ...
          whileTap={{ scale: 0.9 }}
        >
          {chatOpen ? <X size={20} color="#ffffff" /> : <MessageSquare size={20} color="#ffffff" />}
